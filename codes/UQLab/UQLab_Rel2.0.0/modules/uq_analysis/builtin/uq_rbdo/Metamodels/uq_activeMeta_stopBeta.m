function status = uq_activeMeta_stopBeta(current_analysis)
...
crit = mean( abs((BetaPlus-BetaMinus)./ Beta) ) ;
delta = current_analysis.Internal.Constraints.Enrichment.ConvThreshold ;
