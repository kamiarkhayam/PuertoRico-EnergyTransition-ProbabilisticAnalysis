function [success] = uq_inversion_test_func_MultiModels_noDiscrepancy(level)
% UQ_INVERSION_TEST_FUNC_MULTIMODELS_NODISCREPANCY tests the functionality 
%   of Bayesian inversion module for multiple forward models with default 
%   discrepancy options.
%
