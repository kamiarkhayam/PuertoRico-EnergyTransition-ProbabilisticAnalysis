function [success] = uq_inversion_test_func_SigmaKnownScalar(level)
% UQ_INVERSION_TEST_FUNC_SIGMAKNOWNSCALAR tests the functionality of 
%   Bayesian inversion module for known scalar discrepancy variance.
%
