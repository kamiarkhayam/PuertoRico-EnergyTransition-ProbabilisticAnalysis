function [success] = uq_inversion_test_func_Visualize(level)
% UQ_INVERSION_TEST_FUNC_VISUALIZE tests the UQ_PLOTMCMC function called
%   at runtime of the MCMC algorithms.
%
%   See also: UQ_SELFTEST_UQ_INVERSION, UQ_PLOTMCMC
...
Solver.MCMC.T0 = 1e3;
Solver.MCMC.Visualize.Parameters = 3;
