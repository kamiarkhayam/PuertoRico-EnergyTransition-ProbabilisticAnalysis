function [success] = uq_inversion_test_func_SigmaKnownMatrix(level)
% UQ_INVERSION_TEST_FUNC_SIGMAKNOWNMATRIX tests the functionality of 
%   Bayesian inversion module for known matrix discrepancy variance.
%
...
DiscrepancyOpt.Parameters = eye(24);
DiscrepancyOpt.Parameters(5,7) = -0.5;
DiscrepancyOpt.Parameters(7,5) = -0.5;
