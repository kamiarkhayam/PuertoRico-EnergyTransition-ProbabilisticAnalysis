function [success] = uq_inversion_test_func_noDiscrepancy(level)
% UQ_INVERSION_TEST_FUNC_NODISCREPANCY tests the functionality of 
%   Bayesian inversion module with default discrepancy options.
%
