function [success] = uq_inversion_test_func_SigmaUnknownRow(level)
% UQ_INVERSION_TEST_FUNC_SIGMAUNKNOWNROW tests the functionality of 
%   Bayesian inversion module for unknown row discrepancy variance.
%
