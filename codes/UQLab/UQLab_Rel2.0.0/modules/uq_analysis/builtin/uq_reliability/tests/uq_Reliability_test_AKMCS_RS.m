function success = uq_Reliability_test_AKMCS_RS(level)
% SUCCESS = UQ_RELIABILITY_TEST_AKMCS_RS(LEVEL):
%     Comparing the results of AKMCS to the analytical failure
%     probabilities. And checking for some other properties of AK-MCS.
%  
