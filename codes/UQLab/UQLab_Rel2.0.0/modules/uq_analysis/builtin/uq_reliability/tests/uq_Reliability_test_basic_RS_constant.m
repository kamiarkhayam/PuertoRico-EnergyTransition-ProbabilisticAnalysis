function success = uq_Reliability_test_basic_RS_constant(level)
% SUCCESS = UQ_RELIABILITY_TEST_BASIC_RS_CONSTANT(LEVEL)
%     Testing a basic structural reliability analysis (SORM) with a constant
%     input variable
%
