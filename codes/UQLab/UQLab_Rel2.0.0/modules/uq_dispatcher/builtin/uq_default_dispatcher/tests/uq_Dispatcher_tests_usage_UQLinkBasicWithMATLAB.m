function pass = uq_Dispatcher_tests_usage_UQLinkBasicWithMATLAB(DispatcherObj)
%UQ_DISPATCHER_TESTS_USAGE_UQLINKBASICWITHMATLAB tests a dispatched of a
%   UQLink model with all the basic settings with MATLAB/UQLab available
