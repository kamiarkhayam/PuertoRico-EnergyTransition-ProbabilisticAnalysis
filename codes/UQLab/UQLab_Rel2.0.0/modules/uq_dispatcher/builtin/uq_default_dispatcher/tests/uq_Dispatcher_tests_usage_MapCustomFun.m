function pass = uq_Dispatcher_tests_usage_MapCustomFun(DispatcherObj)
%UQ_DISPATCHER_TESTS_USAGE_MAPCUSTOMFUN tests dispatched uq_map with a
%   user-defined function as the mapping function.
%
%   NOTE:
