function pass = uq_Dispatcher_tests_usage_UQLinkInpOut(DispatcherObj)
...
%   code in which the output filename is specified in the input file.
%
...
%     named 'uq_ishigami_inpout.py'; it requires numpy.
...
%     expected to be slightly different due to the representations of
...
EXECNAME = 'uq_ishigami_inpout.py';

% Provide the name of the input file
INPUTFILE  = 'inpout.inp';
OUTPUTFILE = 'inpout.out';
...
ModelOpts.Template = 'inpout.inp.tpl';
