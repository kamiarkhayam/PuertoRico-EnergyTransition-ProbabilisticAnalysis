function pass = uq_Dispatcher_tests_usage_UQLinkMultiInp(DispatcherObj)
%UQ_DISPATCHER_TESTS_USAGE_UQLINKMULTIINP tests a dispatched computation 
%   of a UQLink model with the command line interface of the third-party
%   code having multiple input files.
%
%   The 3rd-party command line interface is of the form:
%
%       <executable> <inputfile 1> <inputfile 2> <inputfile 3> <outputfile>
%
%   NOTE:
%   - This tests uses a Python3 implementation of the Ishigami function
%     named 'uq_ishigami_multi.py'; it requires numpy.
...
COMMANDLINE = sprintf('%s %s %s %s %s', EXECNAME, INPUTFILE1,...
    INPUTFILE2, INPUTFILE3, OUTPUTFILE);
