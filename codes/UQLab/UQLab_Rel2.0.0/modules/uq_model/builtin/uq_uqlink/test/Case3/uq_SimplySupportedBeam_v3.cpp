...
int main(int argc, char* argv[]) {
	...
	if(inputfile.is_open()){
        ...
        iss >> outputfilename;
		if(iss.fail()){
			cout << "Error while reading line 7 from file " << inputfilename << "! Exiting..." << endl;
			exit(EXIT_FAILURE);
		}
        cout << "Outputfilename given in input file: +" << outputfilename << "+" << endl;
	...
	ofstream outputfile(outputfilename.c_str()); //re-converting to char-array necessary
