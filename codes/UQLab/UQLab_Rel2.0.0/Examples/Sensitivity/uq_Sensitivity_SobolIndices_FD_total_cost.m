...
for i = 1:1000
    ...
    ModelOpts.mFile = 'uq_FD_total_cost_surrogate';
    ...
    InputOpts.Marginals(1).Name = 'urnPricePercentile';
    InputOpts.Marginals(1).Type = 'Uniform';
    InputOpts.Marginals(1).Parameters = [0 1]; 

    InputOpts.Marginals(2).Name = 'battPercentileInv';
    InputOpts.Marginals(2).Type = 'Uniform';
    InputOpts.Marginals(2).Parameters = [0 1]; 
    
    InputOpts.Marginals(3).Name = 'battPercentileFix';
    InputOpts.Marginals(3).Type = 'Uniform';
    InputOpts.Marginals(3).Parameters = [0 1]; 
    
    InputOpts.Marginals(4).Name = 'hydPercentileInv';
    InputOpts.Marginals(4).Type = 'Uniform';
    InputOpts.Marginals(4).Parameters = [0 1]; 
    
    InputOpts.Marginals(5).Name = 'hydPercentileFix';
    InputOpts.Marginals(5).Type = 'Uniform';
    InputOpts.Marginals(5).Parameters = [0 1];
    
    InputOpts.Marginals(6).Name = 'solPercentileInv';
    InputOpts.Marginals(6).Type = 'Uniform';
    InputOpts.Marginals(6).Parameters = [0 1]; 
    
    InputOpts.Marginals(7).Name = 'solPercentileFix';
    InputOpts.Marginals(7).Type = 'Uniform';
    InputOpts.Marginals(7).Parameters = [0 1]; 
    
    InputOpts.Marginals(8).Name = 'windPercentileInv';
    InputOpts.Marginals(8).Type = 'Uniform';
    InputOpts.Marginals(8).Parameters = [0 1]; 

    InputOpts.Marginals(9).Name = 'windPercentileFix';
    InputOpts.Marginals(9).Type = 'Uniform';
    InputOpts.Marginals(9).Parameters = [0 1];

    InputOpts.Marginals(10).Name = 'popPercentile';
    InputOpts.Marginals(10).Type = 'Uniform';
    InputOpts.Marginals(10).Parameters = [0 1]; 

    InputOpts.Marginals(11).Name = 'perCapitaPercentile';
    InputOpts.Marginals(11).Type = 'Uniform';
    InputOpts.Marginals(11).Parameters = [0 1];
    
    InputOpts.Marginals(12).Name = 'intensityChange';
    InputOpts.Marginals(12).Type = 'Lognormal';
    InputOpts.Marginals(12).Parameters = [1.6564 0.5396];
    
    InputOpts.Marginals(13).Name = 'frequencyChange'; 
    InputOpts.Marginals(13).Type = 'Lognormal';
    InputOpts.Marginals(13).Parameters = [3.9344 0.4347]; 
    
    InputOpts.Marginals(14).Name = 'elcPriceChangePercentile'; 
    InputOpts.Marginals(14).Type = 'Uniform';
    InputOpts.Marginals(14).Parameters = [0 1];

    InputOpts.Marginals(15).Name = 'corruptionFactor'; 
    InputOpts.Marginals(15).Type = 'Uniform';
    InputOpts.Marginals(15).Parameters = [1 4];
    ...
    SobolOpts.Sobol.SampleSize = 5e3;
    %%
