...
# calculate nodal masses -- lump floor masses at frame nodes
	...
	set Floor2Weight 500.0;		# weight of Floor 2 in kips
	set Floor3Weight 590.0;		# weight of Floor 3 in kips
...
# define column section W24x131 for Story 1 & 2
	...
	set Mycol_12 <X0001>;	# yield moment
...
# define beam section W27x102 for Floor 2 & 3
	...
	set Mybeam_23 <X0002>;	# yield moment at plastic hinge location (i.e., My of RBS section, if used)
...
# record base shear reactions
	recorder Node -file Vbase.out -node 117 217 31 -dof 1 reaction;
	
# record story 1 column forces in global coordinates 
	recorder Element -file Fcol111.out -ele 111 force;
	recorder Element -file Fcol121.out -ele 121 force;
	recorder Element -file Fcol731.out -ele 731 force;
