...
for i = 1:1000
    ...
    ModelOpts.mFile = 'uq_BAU_total_cost_surrogate';
    ...
    InputOpts.Marginals(1).Name = 'gasPricePercentile';
    InputOpts.Marginals(1).Type = 'Uniform';
    InputOpts.Marginals(1).Parameters = [0 1]; 

    InputOpts.Marginals(2).Name = 'coalPricePercentile';
    InputOpts.Marginals(2).Type = 'Uniform';
    InputOpts.Marginals(2).Parameters = [0 1]; 
    
    InputOpts.Marginals(3).Name = 'solPercentileInv';
